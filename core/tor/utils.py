...
class TorUtility:
    ...
    def get_current_ip(self):
        ...
        session.proxies = {'http': f'socks5h://{TOR_SOCKS_HOST}:{TOR_SOCKS_PORT}',
        ...
        while True:
            try:
                if self.verbose:
                    ...
                    print(
                        f"[{self.COLOR_CYAN}5{self.COLOR_RESET}] View Tor IP History")
                    print(
                        f"[{self.COLOR_CYAN}6{self.COLOR_RESET}] Start nyx (Tor monitor)")
